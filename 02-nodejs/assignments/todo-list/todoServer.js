...
app.post("/todos", (req, res) => {
  ...
  res.status(httpStatus.StatusCodes.CREATED).json({ id: todo.id });
});
...
app.put("/todos/:id", (req, res) => {
  ...
  return res.status(httpStatus.StatusCodes.OK).json(todos[index]);
});
